...
public sealed class CsxEmitter : IScriptEmitter
{
    ...
    private static void AppendOAuthFunctions(StringBuilder sb)
    {
        ...
        sb.AppendLine("HttpListener BeginCallbackListener(string callbackUrl)");
        sb.AppendLine("{");
        ...
        sb.AppendLine("async Task<Dictionary<string, string>> AwaitOAuthCallbackAsync(HttpListener listener)");
        sb.AppendLine("{");
        sb.AppendLine("  try");
        sb.AppendLine("  {");
        ...
        sb.AppendLine("Process? TryStartOAuthCaptureProcess(string callbackUrl, string state)");
        sb.AppendLine("{");
        sb.AppendLine("    try");
        sb.AppendLine("    {");
        sb.AppendLine("        var psi = new ProcessStartInfo");
        ...
        sb.AppendLine("bool IsHttpLoopbackCallback(string callbackUrl)");
        sb.AppendLine("{");
        ...
        sb.AppendLine("async Task<Dictionary<string, string>> AwaitOAuthCaptureProcessAsync(Process process)");
        sb.AppendLine("{");
        ...
        sb.AppendLine("void PresentAuthorizeUrl(string profileName, string authorizeUrl, string browserLaunch)");
        sb.AppendLine("{");
